...
echo -e "${kjlan}一键脚本工具 v$sh_v （支持Ubuntu/Debian系统）${bai}"
echo -e "${kjlan}-输入${huang}k${kjlan}可快速启动此工具-${bai}"
echo "------------------------"
echo "1. 系统信息查询"
echo "2. 系统更新"
echo "3. 系统清理"
...
case $choice in
  ...
  7)
    while true; do
      ...
      echo "▶ 面板工具"
      echo "------------------------"
      echo "1. 1Panel新一代管理面板"
      echo "2. NginxProxyManager可视化面板"      
          ...
          5)
            ...
            case "$Limiting" in
              1)
                ...
                cd ~
                curl -Ss -O https://raw.githubusercontent.com/rts600/sh/main/Limiting_Shut_down.sh
